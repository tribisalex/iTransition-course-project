      ...
      <Container className='d-flex flex-column justify-content-center align-items-center'
        ...
        <Card>
          <Form className='d-flex justify-content-center align-items-center'>
            ...
            <Button variant={"outline-primary"} className='m-2' onClick={categoryId ? () => handleEditCategory(categoryId, categoryName) : handleAddCategory}>{categoryId ? 'Edit category' : 'Add category'}</Button>
          </Form>
        </Card>
        <Row style={{width: '60%'}} >
        <Table responsive="md" hover style={{textAlign: 'center'}}>
          ...
          <tr>
            <th>id</th>
            <th style={{cursor: 'pointer'}} onClick={() => handleSortBy('categoryname')}>Name</th>
            <th>Delete</th>
            <th>Edit</th>
          </tr>
          </thead>
          ...
          {categories.map((category,key) =>
            <tr>
              ...
              <td onClick={() => handleDeleteCategory(category.id)} style={{cursor: 'pointer'}}>Delete</td>
              <td onClick={() => {
